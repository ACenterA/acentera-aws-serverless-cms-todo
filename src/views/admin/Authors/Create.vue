...
import { ALL_AUTHORS, CreateAuthorMutation } from '@/gql/queries/authors.gql'
    ...
    createProject() {
      ...
      this.$apollo.mutate({
        ...
        update: (store, { data: { createProject }}) => {
          ...
          var queryKey = ALL_AUTHORS
          var itemKey = 'listAllAuthors'
        ...
        */
        ...
        this.$notify({
          title: this.$t('author.create.title'),
          message: this.$t('author.create.success.message'),
          type: 'success',
          duration: 2000
        })
        this.loading = false
        this.$router.push({ name: 'AdminAuthorsList' })
      }).catch(error => {
        this.$notify({
          title: this.$t('author.create.title'),
          subtitle: '',
          message: this.$t('author.create.error.message', { error: error }),
          type: 'error',
          duration: 5000
        })
        this.loading = false

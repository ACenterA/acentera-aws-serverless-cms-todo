...
import { deleteTask, updateTask, listTasks, CreateTaskMutation } from '@/gql/queries/tasks.gql'
...
export default {
  ...
  apollo: {
    ...
    projects: {
      query: () => listTasks,
      variables() {
        console.error('query by project of')
      ...
      update(data) {
        this.list = data.listTasks.items
        this.total = data.listTasks.items.length
      ...
      subscribeToMore: {
        ...
        updateQuery: (previousResult, { subscriptionData }) => {
          ...
          const previousItems = previousResult.listTasks.items

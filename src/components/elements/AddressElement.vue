  ...
  <div>
    <div class="row">
      <div class="col-xs-12">
        ...
        <div v-if="field.subfields[0].active === 1" class="form-group">
          <input :name="field.subfields[0].name" :placeholder="field.subfields[0].placeholder" type="text" class="form-control">
    ...
    <div class="row">
      <div class="col-xs-12">
        <div v-if="field.subfields[1].active === 1" class="form-group">
          ...
          <input :name="field.subfields[1].name" :placeholder="field.subfields[1].placeholder" type="text" class="form-control">
    ...
    <div v-if="field.subfields[2].active === 1 || field.subfields[3].active === 1" class="row">
      <div v-if="field.subfields[2].active === 1" class="col-xs-6">
        <input :name="field.subfields[2].name" :placeholder="field.subfields[2].placeholder" type="text" class="form-control">
        <span class="help-block">{{ field.subfields[2].label }}</span>
      </div>
      <div v-if="field.subfields[3].active === 1" class="col-xs-6">

        <input :name="field.subfields[3].name" :placeholder="field.subfields[3].placeholder" type="text" class="form-control">
    ...
    <div v-if="field.subfields[4].active === 1 || field.subfields[5].active === 1" class="row">
      <div v-if="field.subfields[4].active === 1" class="col-xs-6">
        ...
        <input :name="field.subfields[4].name" :placeholder="field.subfields[4].placeholder" type="text" class="form-control">

        <span class="help-block">{{ field.subfields[4].label }}</span>
      </div>
      <div v-if="field.subfields[5].active === 1" class="col-xs-6">

        <select :name="field.subfields[5].name" class="form-control">
